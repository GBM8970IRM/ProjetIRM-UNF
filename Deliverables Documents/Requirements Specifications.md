...
[**2 LES INTERVENANTS	3**](#heading=)

[**2.1 L’équipe de travail	3**](#heading=)

[**2.2 Le client	3**](#heading=)

[**2.3 Les usagers du produit	3**](#heading=)

[**3 LES CONTRAINTES DU PROJET	3**](#heading=)

[**3.1 Les contraintes du produit final	3**](#heading=)

[**3.2 L’environnement d’implémentation du dispositif	3**](#heading=)

[**3.3 Les contraintes temporelles	4**](#heading=)

[**3.4 Les contraintes budgétaires	4**](#heading=)

[**3.5 Les faits	4**](#heading=)

[**3.6 Les lois et les réglementations	5**](#heading=)

[**4 LES EXIGENCES FONCTIONNELLES	5**](#heading=)

[**4.1 Le travail	5**](#heading=)

[4.1.1 Environnement de travail	5](#environnement-de-travail)

[4.1.2 La division des tâches	5](#heading=)

[**4.2 Le produit	5**](#heading=)

[4.2.1 Le mandat	5](#le-mandat)

[4.2.2 Les usages	6](#heading=)

[4.2.3 Les frontières	6](#heading=)

[**5 LES EXIGENCES PHYSIQUES ET VISUELLES	7**](#heading=)

[**5.1 Style	7**](#style)

[**5.2 Ergonomie	7**](#heading=)

[**5.3 Matériaux	7**](#heading=)

[**6 LES EXIGENCES LIÉES À L’UTILISATION	7**](#heading=)

[**6.1 Facilité d’utilisation	7**](#heading=)

[**6.2 Manuel de l’usager	8**](#heading=)

[**6.3 Formation à donner	9**](#heading=)

[**6.4 Accessibilité	9**](#heading=)

[**7 LES EXIGENCES DE PERFORMANCE	9**](#heading=)

[**7.1 Fréquence d'échantillonnage	9**](#heading=)

[**7.2 Précision	9**](#heading=)

[**7.3 Nombre/durée d’utilisation	10**](#heading=)

[**8 LES EXIGENCES DE SÉCURITÉ	10**](#heading=)

[**8.1 Clientèle cible	10**](#clientèle-cible)

[**8.2 Dangers	10**](#heading=)

[**9 LES NUMÉROS D’IDENTIFICATION DES EXIGENCES	11**](#heading=)
...
| 7 | Le produit doit comporter une interface web personnalisable pour la visualisation des données. | O |  |
...
| Réf. | Exigence | Test | Notes |
| :---- | :---- | ----- | :---- |
| 1 | Le système central du produit (Arduino Opta et circuits électriques) doit être contenu dans un boîtier respectant des dimensions maximales de 30x20x20cm.   | M |  |
| 2 | Le boîtier doit être de couleur neutre, soit noir, gris ou blanc. | O |  |
...
| 2 | Le boîtier et l’ensemble de composantes intérieures doivent peser en dessous 5 kg.  | M |  |
| 3 | Le boîtier doit avoir une ouverture qui peut être sécurisée lors des mouvements afin d’éviter qu’elle ne s’ouvre. | O |  |
| 4 | Le dessous du boîtier doit posséder 4 pattes antidérapantes pour éviter qu’elle ne bouge. | O |   |

   3. ## **Matériaux**

| Réf. | Exigence | Test | Notes |
| :---- | :---- | ----- | :---- |
| 1 | Le boîtier doit être fabriqué avec un matériel résistant au températures de 50℃.  | M |  |
...
| 3 | Les alertes affichées directement sur l’interface web doivent indiquer quelle métrique l’a déclenchée, la valeur dangereuse qui a été détectée et l’heure de détection de cette valeur et être affichée en rouge. | O |  |
...
| Réf. | Exigence | Test | Notes |
| :---- | :---- | ----- | :---- |
| 1 | Les mesures de température et d’humidité dans la salle IRM doivent être prises à intervalle de maximum une minute. | M |  |
...
| Réf. | Exigence | Test | Notes |
| :---- | :---- | ----- | :---- |
| 1 | La mesure de la température de la salle IRM doit avoir une exactitude de \+/- 1 degré Celsius. | M |  |
| 2 | Les mesures de température d’entrée et de sortie de l’eau du système refroidissant doivent avoir une exactitude de \+/- 1 degré Celsius. | M |  |
| 3 | La mesure de la température de la salle IRM doit avoir une précision de \+/- 0.3 degré Celsius. | M |  |
| 4 | Les mesures de température d’entrée et de sortie de l’eau du système refroidissant doivent avoir une précision de \+/- 0.3 degré Celsius. | M |  |
| 5 | La mesure de l’humidité de la salle IRM doit avoir une précision de 3% RH. | M |  |
| 6 | La mesure du débit de l’eau à l’entrée du chiller doit permettre d’observer un écart maximal de 0.5 L/min. | M |  |

   3. ## **Nombre/durée d’utilisation**

| Réf. | Exigence | Test | Notes |
| :---- | :---- | ----- | :---- |
| 1 | Le dispositif de mesure de température et d’humidité de la salle IRM doit être fonctionnel pour une durée d’au moins un an avant quelconque changement dans l’alimentation. | M |  |
...
| 0.4 | 9 avril 2025 | Ajustement des exigences par rapport à la procédure de tests | Emmy, Héloïse et Louis-Antoine  |
